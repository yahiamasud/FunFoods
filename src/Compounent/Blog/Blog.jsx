...
const Blog = () => {
    return (
        <div className='contaimer m-5'>
            ...
            <p className='text-2xl mt-5'> (1) Tell us the differences between uncontrolled and controlled components ?</p>
            <p>Ans:In React, controlled components refer to components that have their state and behavior controlled by the parent component. These components rely on props passed down from the parent component to update their state and behavior. Uncontrolled components refer to components that manage their own state internally.</p>
            <p className='text-2xl mt-5'> (2) How to validate React props using PropTypes?</p>
            ...
            <p className='text-2xl mt-5'>(3) Tell us the difference between nodejs and express js.?</p>
            ...
            <p className='text-2xl mt-5'> (4) What is a custom hook, and why will you create a custom hook??</p>
